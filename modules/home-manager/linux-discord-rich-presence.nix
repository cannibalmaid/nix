  ...
  config = mkIf cfg.enable {
    systemd.user.services = {
      linux-discord-rich-presence = {
        ...
        Service = {
          ExecStart = ''${pkgs.linux-discord-rich-presence}/bin/linux-discord-rich-presence --config /home/mia/.config/home-manager/pkgs/linux-discord-rich-presence/config.sh'';
          Restart = "always";
        };
      };
    };
